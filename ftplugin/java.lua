...
local config = {
  ...
  settings = {
    java = {
      home = '/home/ricardo/.sdkman/candidates/java/current/bin/java',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = 'JavaSE-11',
            path = '/home/ricardo/.sdkman/candidates/java/11.0.23-tem',
          },
          {
            name = 'JavaSE-17',
            path = '/home/ricardo/.sdkman/candidates/java/17.0.11-tem',
          },
          {
            name = 'JavaSE-21',
            path = '/home/ricardo/.sdkman/candidates/java/21.0.3-tem',
          },
        },
      },
      maven = {
...
-- Keymaps
vim.keymap.set('n', '<leader>rf', ":%s/\\(\\(static\\|private\\|public\\) \\)\\@<!final //g<cr>:let @/=''<CR><C-o>")
